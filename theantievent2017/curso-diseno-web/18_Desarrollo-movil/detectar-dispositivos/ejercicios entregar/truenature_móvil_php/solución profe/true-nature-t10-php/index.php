...
<script>
function menu(){
	if(document.getElementById("mimenu").style.display=="block"){
...
window.onload=function(){
	document.getElementById("logoMenu").onclick=menu;
}
...
<div id="wrapper">
	<header id="titulo">
			...
			<p><img id="logoMenu" src="images/menu.jpg" width="45" height="45" alt="menu"> Template Design by CSS Templates </p>
	</header>
	<section id="foto">
	</section>
	<nav id="menu">
